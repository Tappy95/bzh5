<template>
  <div id="app" style="height:100vh;overflow: auto;background-color:#f64645;">
    ...
    <div class="wrap">
      ...
      <!-- <div style="height:8rem;background-color:#d92733;"></div> -->
  ...
  methods: {
    ...
    getparm() {
      if(this.isAndroid()){
        ...
        this.$get("/wish/mChannelInfo/getDownloadUrl", par).then(res => {
      ...
      this.$get("/push/validateCode/validateSmsCode", parameterData).then(res => {
          if ((res.statusCode + "").startsWith("2")) {
            if (res.data.res == true) {
              ...
              this.$get("/wish/userInfo/regWishH5", parameter).then(res => {
                if ((res.statusCode + "").startsWith("2")) {
