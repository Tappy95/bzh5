<template>
  <div id="app" style="width:100vw;height: auto;overflow: auto;">
    <!--<div class="jf_header">-->
    ...
    <div class="wrap">
      <div class="list_1">
        <img src="../../assets/channelDownload/channelDownload_1_01.jpg" />
      </div>
      <div class="list_2">
        <img
          class="btn-gif"
          @click="downTap"
          src="../../assets/channelDownload/channelDownload_btn.gif"
        />
      ...
      <div class="footer" v-show="isShowLoad">
        <div class="center">
          ...
          <div class="right">
            <img @click="registerTap" src="../../assets/channelDownload/channelDownload_load.png" />
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="cd_box" v-show="isShowBox" @touchmove.prevent>
      <div class="cd_box_inner">
        ...
        <div class="cd_inner_con">
          ...
          <div class="cd_btn" @click="registerTap">
    ...
    <!-- <div class="show_box" v-show="isShowTrue">
      <div class="show_box_inner">
        <div>
          <p class="show_font">是否下载安装包？</p>
          <div class="show_line"></div>
          <div class="show_dis">
            <p @click="close">取消</p>
            <span></span>
            <p @click="registerTap">确定</p>
          </div>
        </div>
      </div>
    </div> -->
    ...
    <div class="register_box" v-if="isShow" @touchmove.prevent>
      <div class="inner">
        <img class="tip" src="../../assets/channelDownload/cover_tip.png" />
      </div>
    </div>
  </div>
</template>
            ...
            if (res.data.res == true) {
              ...
              this.$get("/api/userInfo/regChannelH5", parameter).then(res => {
                if ((res.statusCode + "").startsWith("2")) {
                  ...
                  if(this.isIos()){
                    window.location.href = '/iosDownload.html?channelCode='+this.channelCode;
                    // this.$router.push({
                    //     path:'/iosDownload',
                    //     // query:{
                    //     //     token:this.token,
...
.register_box .inner::before {
  ...
  z-index: -1;
  background-image: url("../../assets/channelDownload/channelDownload_1_01.jpg");
  background-position: center top;
  background-size: cover;
