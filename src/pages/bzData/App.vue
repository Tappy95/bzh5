<template>
    <div style="height: 100vh;background: #8A16E4;overflow: auto;position: relative;">
        <div class="bzs_head" @click="back">
            <img src="../../assets/enlighteningRight.png" />
            <p>金猪每日战报</p>
        </div>
        <div class="bzs_bg">
            <img src="../../assets/bzData/bzdbg.png" alt="">
        </div>
        <div class="bzs_block_one">
            <img src="../../assets/bzState/bgone.png" alt="">
        </div>
        <div class="bzs_block_imgs">
            <p>前30名，每天都派奖！(单位：金猪)</p>
            <img src="../../assets/bzData/one.png" alt="">
            <img src="../../assets/bzData/two.png" alt="">
            <img src="../../assets/bzData/three.png" alt="">
            <img src="../../assets/bzData/four.png" alt="">
            <img src="../../assets/bzData/five.png" alt="">
            <img src="../../assets/bzData/six.png" alt="">
            <img src="../../assets/bzData/seven.png" alt="">
        </div>
        <div class="bzs_meiri">
            <img src="../../assets/bzData/meiri.png" alt="">
        </div>
        ...
        <div class="bzs_huodong">
            <img src="../../assets/bzData/huodong.png" alt="">
        </div>
        <div class="bzs_block_three">
            ...
            <p><span>1、</span>金猪乐园内活动</p>
            <img src="../../assets/bzState/jlsm.png" alt="">
            <p><span>1、</span>每日奖励一次冲榜前30名用户，每小时数据刷新一次；</p>
            <p><span>2、</span>累计赚取金额=金猪乐园内每天赚取的金猪总和；</p>
            <p><span>3、</span>奖励实际以金猪形式发放；</p>
            <img src="../../assets/bzState/lqfs.png" alt="">
            <p style="margin-bottom:0.5rem;"><span>1、</span>每天活动奖励将于次日早上11点发放至金猪乐园【我的仓库】</p>
        </div>
        <div style="position: absolute;top: 63rem;">.</div>
        <div class="bzs_btn" @click="openRecruitBox">
            <img src="../../assets/bzData/btn.png" alt="">
        </div>
    </div>
</template>
<script>
export default {
    ...
    methods: {
        getInfo(){
            ...
            this.$get('/api/rankPig/queryMyRankDay', parameterData).then(res => {
                if((res.statusCode+"").startsWith("2")){
                    for(var i = 0;res.data.lRankCoins.length>i;i++){
                        res.data.lRankCoins[i].pigBalance = (res.data.lRankCoins[i].pigBalance / 10000).toFixed(2);
                    }
                    res.data.my.pigBalance = (res.data.my.pigBalance / 10000).toFixed(2);
        ...
        jump(){
            if(this.historys == null || this.historys == 'null'){
                ...
                window.location.href = '/historyShark.html?historys='+this.historys;
            }
        },
        openRecruitBox(){
            let parameterData={
            ...
            this.$get('/api/mChannelConfig/check28RightNews',parameterData).then(res =>{
                if((res.statusCode+"").startsWith("2")){
                    if(res.data.game28 == 2){
                        if(this.isAndroid()){
                            window.android.tobaozhuLottery();
                        }else if(this.isIos()){
                            window.betAction();
                        }
                    }else{
...
.bzs_block_imgs img:nth-of-type(7){
    position: absolute;
    top: 21.6rem;
    left: 11.6rem;
    width: 4.2rem;
