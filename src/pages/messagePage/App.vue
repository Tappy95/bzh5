    ...
    <div id="app" style="height: 100vh;background: #F3F5F8;overflow: auto;">
        ...
        <scroller :on-refresh="refresh" :on-infinite="infinite" :noDataText="noDataText">
            ...
            <div class="messageCenter-foot">
                <!-- 通知 -->
                <div v-if="listData.length>0" v-for="(item,index) in listData" @click="jumpInform(item.id)">
                    <mt-cell-swipe
                        :right="[
                            {
                            content: '删除',
            ...
            <div style="margin-top: 5rem;color: #3C3E59;font-size: 1rem;text-align: center;" v-if="nolisttz">暂无数据</div>
